...
class _HomeState extends State<Home> {
  ...
  void navigateToImageDetailPage(
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            ImageDetailPage(imagePath: imagePath, caption: caption),
      ),
    );
  }
    ...
    try {
      if (controller != null) {
        ...
        if (controller!.value.isInitialized) {
          ...
          XFile image = await controller!.takePicture(); // Capture the image
          setState(() async {});
          // Update the
          if (image != null) {
            ...
            // if (croppedFile != null) {
            //   navigateToImageDetailPage(context, croppedFile.path, ' ');
            // }
                          ...
                          Positioned(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                setState(() {
                                  currentFlashMode =
                                      getNextFlashMode(currentFlashMode);
                                });
                            ...
                            child: Container(
                              ...
                              child: GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Image.asset(
                                    'assets/shutter.png',
                                    color: Color.fromARGB(255, 26, 184, 232),
                                  ),
                                ),
                              ),
                            ),
